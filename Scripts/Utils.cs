...
public static class Utils
{
    ...
    public static float CeilToNearestX(this float n, float x)
    {
        return Mathf.Ceil(n / x) * x;
    }
    ...
    {
        float _x = FloorToNearestX(n.x, x);
        float _y = FloorToNearestX(n.y, x);
        float _z = FloorToNearestX(n.z, x);
    ...
    public static Vector3 CeilToNearestX(this Vector3 n, float x)
    {
        float _x = CeilToNearestX(n.x, x);
        float _y = CeilToNearestX(n.y, x);
        float _z = CeilToNearestX(n.z, x);
    ...
    public static int Mod(this float n, float x)
    {
        return Mathf.RoundToInt((n % x + x) % x);
    }
